    ...
    <div className="min-h-screen grid grid-cols-12">
      ...
      <aside className="col-span-12 md:col-span-3 lg:col-span-2 bg-[#0a2a06] text-white p-4 lg:p-6 sticky top-0 h-screen hidden md:flex flex-col gap-4">
        ...
        <div className="mt-auto flex flex-col gap-1">
          <button
            className="flex items-center gap-2 px-3 py-2 rounded-md text-white/80 hover:text-white hover:bg-white/10"
            onClick={() => nav("/profile")}
          >
            <Settings size={16} /> Configuración
          </button>
          <button
            className="flex items-center gap-2 px-3 py-2 rounded-md text-red-300 hover:text-white hover:bg-red-500/20"
            onClick={logout}
          >
      ...
      <div className="col-span-12 md:col-span-9 lg:col-span-10 bg-gray-50 min-h-screen">
        <header className="brand-gradient shadow text-white px-4 lg:px-6 py-3 md:hidden sticky top-0">
          Internet Perla
        </header>
        <motion.main
